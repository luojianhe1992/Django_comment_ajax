...
urlpatterns = [
    ...
    # add message page
    url(r'add_message/$', 'WebApp.views.add_message', name='add_message'),

    # show all messages and comments page
    url(r'show_messages/$', 'WebApp.views.show_messages', name='show_messages'),

    # add comment to the message
    url(r'add_comment/$', 'WebApp.views.add_comment', name='add_comment'),

    url(r'add_comment_ajax/$', 'WebApp.views.add_comment_ajax', name='add_comment_ajax'),
